from predictor_app.db.models import UserProfile, RefreshToken
from predictor_app.db.schema import UserProfileSchema, UserLoginSchema
...
from predictor_app.config import (SECRET_KEY, ALGORITHM,
